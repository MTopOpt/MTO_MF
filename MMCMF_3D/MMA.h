...
class MMA{
	public:
		...
		MMA(PetscInt n, PetscInt m, Vec x, PetscScalar *a,PetscScalar *c, PetscScalar *d,double init,double dec,double inc,double dec2,double inc2);
		...
		PetscErrorCode Update(Vec xval, Vec dfdx, PetscScalar *gx, Vec *dgdx, Vec xmin, Vec xmax,PetscScalar raa0,double dec,double inc,double dec2,double inc2,int n);
		...
		PetscErrorCode SetOuterMovelimit(PetscScalar Xmin, PetscScalar Xmax, PetscScalar movelim, PetscScalar movelim2, Vec x, Vec xmin, Vec xmax,int allcells);
	...
	private:
		...
		PetscErrorCode GenSub(Vec xval, Vec dfdx, PetscScalar *gx, Vec *dgdx, Vec xmin, Vec xmax,PetscScalar raa0,PetscInt n);
		...
		PetscScalar asyminit,asymdec,asyminc,asymdec2,asyminc2;
